...
func TestGetTagTargetError(t *testing.T) {
	tempDir := t.TempDir()
	repo := CreateTestGitRepository(t, tempDir, false)

	// Try with a blob instead of tag
...
func TestVerifyTagSignatureError(t *testing.T) {
	tempDir := t.TempDir()
	repo := CreateTestGitRepository(t, tempDir, false)
...
func TestTagUsingSpecificKeyComprehensive(t *testing.T) {
	tempDir := t.TempDir()
	repo := CreateTestGitRepository(t, tempDir, false)
	...
	t.Run("create tag with message without newline", func(t *testing.T) {
		// Test that message without trailing newline gets one added
	...
	t.Run("create tag pointing to tree", func(t *testing.T) {
		// Tags can point to any Git object, including trees
...
func TestVerifyTagSignatureWithDifferentKeyTypes(t *testing.T) {
	tempDir := t.TempDir()
	repo := CreateTestGitRepository(t, tempDir, false)
...
func TestGetTagTargetWithDifferentObjects(t *testing.T) {
	tempDir := t.TempDir()
	repo := CreateTestGitRepository(t, tempDir, false)
